...
class SupportedGroups extends BaseExtension
{
    ...
    /**
     * @param \Cloak\Tls\Enums\NamedGroup[] $named_group_list
     */
    ...
    {
        $named_group_list = implode(array_map(fn(NamedGroup $named_group) => uint16($named_group->value), $this->named_group_list));
